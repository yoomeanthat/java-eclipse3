...
public class RunnableEx {
	...
	public static void main(String[] args) {
		...
		Runnable r2 = () -> {
			System.out.println("run !! 람다");
		};

		r2.run();

		/*
		 * //제너릭타입은 객체타입가능함, int -> Integer , double -> Double interface Consumer<T> {
		 * void accept(T t) }
		 */
		...
		//매개변수로 숫자를 입력 받아서 짝수 판단 (true, false)
